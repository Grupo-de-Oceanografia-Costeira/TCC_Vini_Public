...
def main():
	...
	lons = np.genfromtxt('data/csv/0110_lon.csv', delimiter=',')
	lats = np.genfromtxt('data/csv/0110_lat.csv', delimiter=',')
	data = np.genfromtxt('data/csv/0110_temp.csv', delimiter=',')
